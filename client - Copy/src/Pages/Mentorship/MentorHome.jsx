...
function MentorHome() {
  return (
    <HomeLayout>
      <div className="min-h-screen w-full flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8" style={{ maxWidth: '100vw' }}>
        <h1 className="text-black text-3xl font-bold mb-8 text-center w-full">Mentor Home</h1>
