    ...
    <HomeLayout>
      <div className="flex justify-center items-center min-h-screen ">
        <form
          ...
          className="lg:w-[450px] w-[90%] md:w-1/2 h-fit p-7 flex flex-col justify-between gap-5 rounded-md bg-white text-black shadow-md"
        >
          ...
          <div className="flex items-center w-full gap-4 border-2 border-yellow-500 px-4 rounded-lg h-14 bg-slate-900">
            <label
              htmlFor="oldPassword"
              className="text-xl hidden lg:block md:block text-black"
            >
              <BsKey />
            </label>
            <input
              ...
              className="py-2 border-0 outline-0 text-xl text-white bg-transparent w-full capitalize"
