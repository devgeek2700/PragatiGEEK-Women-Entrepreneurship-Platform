    ...
    <HomeLayout>
      <div className="min-h-screen p-4 lg:p-8">
        <div className="max-w-7xl mx-auto">
          {/* Title */}
          <h1 className="text-3xl font-bold text-black mb-8">View Products</h1>
          ...
          <div className="mb-8 flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <select
              ...
              className="px-4 py-2 rounded-lg border border-gray-300 bg-white text-black focus:outline-none focus:ring-2 focus:ring-blue-500 capitalize"
            >
