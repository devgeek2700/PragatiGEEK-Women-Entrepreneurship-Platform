  ...
  return (
    <HomeLayout>
      <div className="min-h-screen py-8 px-4 md:px-8 lg:px-16">
        <h1 className="text-3xl text-black font-bold text-center mb-8">My Orders</h1>
                      ...
                      >
                        ...
                        {order.products.map((item) => (
                          <button
                            key={item._id}
                            onClick={() =>
                              navigate(`/product/order/${order._id}`)
                            }
                    ...
                    orders.courses.map((course) => (
                      ...
                      >
                        <div className="flex justify-between items-start">
                          ...
                          <div className="text-right">
                            <p className="font-bold text-blue-500 text-lg">₹{course.price}</p>
