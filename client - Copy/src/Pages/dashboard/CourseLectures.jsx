                            ...
                            <div className="lg:w-[70%] md:w-[60%] md:h-screen lg:h-screen h-[50vh] overflow-y-scroll">
                                <div className="w-full h-16 flex justify-between items-center lg:px-12 px-6 bg-gray-800 lg:sticky md:sticky top-0 z-10 mb-4 shadow-lg">
                                    ...
                                    <div>
                                        <label className="flex items-center h-full gap-4">
                                            <span className="font-semibold text-white text-xl lg:block md:block hidden">Autoplay</span>
                                            <Switch
                                ...
                                <div className="h-full lg:overflow-y-scroll md:overflow-y-scroll px-4">
                                    ...
                                    <div className="flex flex-col gap-4 p-8 bg-gray-800 rounded-lg shadow-lg mb-6">
                                        <h1 className="text-white font-bold text-3xl border-b border-gray-700 pb-4">Overview</h1>
                                    ...
                                    <ul className="menu gap-4">
                                        {lectures &&
                                            lectures.map((lecture, idx) => {
                                                return (
                                                    <li key={lecture._id} className="border-b border-gray-700 last:border-none">
                                                        <div className="flex justify-between items-center p-4 hover:bg-gray-700 rounded-lg cursor-pointer transition-colors">
                                                            <span
                                                                className={`text-lg font-semibold capitalize ${currentVideo === idx ? 'text-yellow-400' : 'text-white'}`}
                                                            ...
                                                            {role === "ADMIN" && (
                                                                <div className="flex gap-4">
                                                                    <button className="text-xl text-blue-400 transform transition-all hover:scale-110 hover:text-blue-300"
                                                                        onClick={() => navigate(`/course/${state?.title}/${state?._id}/lectures/editlecture`, { state: lectures[idx] })}>
                                                                        <FiEdit />
                                                                    </button>
                                                                    <button
                                                                        className="text-xl text-red-400 transform transition-all hover:scale-110 hover:text-red-300"
