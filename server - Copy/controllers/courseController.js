...
export const getMyCourses = async (req, res, next) => {
    try {
        ...
        const payments = await Payment.find({
            ...
            path: 'course_id',
            select: 'title description category thumbnail numberOfLectures createdBy price rating numberOfRatings'
        });
        ...
        const purchasedCourses = [...new Map(
            payments
                ...
                .map(payment => [payment.course_id._id.toString(), payment.course_id])
        ).values()];
